...
}:
{
  ...
  services.udev.extraRules = ''
    ...
    ATTRS{idVendor}=="0x15ba", ATTRS{idProduct}=="0x0003", TAG+="uaccess"
    ATTRS{idVendor}=="0x15ba", ATTRS{idProduct}=="0x0004", TAG+="uaccess"
    ATTRS{idVendor}=="0x15ba", ATTRS{idProduct}=="0x002a", TAG+="uaccess"
    ATTRS{idVendor}=="0x15ba", ATTRS{idProduct}=="0x002b", TAG+="uaccess"
    ...
    ATTRS{idVendor}=="1a86", ATTRS{idProduct}=="8011", TAG+="uaccess"
